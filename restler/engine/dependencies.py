        ...
        for type in destructors:
            ...
            for value in reversed(self.overflowing[type]):
                ...
                if fully_rendered_data:
                    ...
                    if status_str in DELETED_CODES_ASYNC:
                        ...
                        # since this may stall the GC.  Instead, record the polling location and record the status
                        # on the next collection.
                        # Record the response to be polled on a future iteration.
